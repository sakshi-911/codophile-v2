window.addEventListener("load", function(){
    ...
    const property_css_playground_child = document.querySelector("#property_css_playground > div > img");
    ...
    function upadate_everything(params) {
        ...
        css_code_container.innerHTML = `
            filter : blur(${input_elements[0].value}px)
        ...
        property_css_playground_child.style.filter = `
